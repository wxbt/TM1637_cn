 ...
 * Four Digit Display
 */
//% weight=100 color=#1C86EE icon="\uf278" block="外设_四位数码管"
namespace TM1637 {
    ...
    export class TM1637LEDs {
         ...
         */
        //% blockId="TM1637_set_intensity" block="%tm|设定强度 %val"
        ...
        /**
          ...
          */
        //% blockId="TM1637_shownum" block="%tm|显示编号 %num"
        ...
        /**
          ...
          */
        //% blockId="TM1637_showhex" block="%tm|显示十六进制数字 %num"
        //% weight=90 blockGap=8
        //% parts="TM1637"
        showHex(num: number) {
            if (num < 0) {
         ...
         */
        //% blockId="TM1637_showDP" block="%tm|点指向 %bit|显示 %show"
         ...
         * clear LED. 
         */
        //% blockId="TM1637_clear" block="清空 %tm"
    ...
    //% blockId="TM1637_create" block="CLK %clk|DIO %dio|强度 %intensity|LED数量 %count"
